// src/components/navigation/Sidebar2.tsx
'use client'; 
...
const teacherInfoLocal = { name: 'Dr. Sarah Mitchell' };
...
export default function Sidebar2() {
    ...
    const getIsActive = (slug: string) => {
        const href = `/teacher/${slug === 'home' ? '' : slug}`;
        ...
        >
            ...
            <nav className={`flex-1 space-y-2 ${sidebarPadding}`}>
                {baseNavItems.map((item) => {
                    ...
                    const href = `/teacher/${item.slug === 'home' ? '' : item.slug}`;
            ...
            <div className={`mt-auto mb-4 ${sidebarPadding}`}>
                ...
                {isSidebarOpen ? (
                    ...
                    >
                        Welcome, {teacherInfoLocal.name.split(' ')[0]}
