...
import { ChevronLeft, Home, BookOpen, Award, BarChart, Settings, Sun, Moon, LogOut, ChevronDown, Loader2, TrendingUp, Network } from 'lucide-react'; 
...
const baseNavItems = [
    ...
    { name: 'Relationships', icon: Network, slug: 'relationships' },
